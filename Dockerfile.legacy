# Temporalily use the old image as base while we are working out the issues with the latest google-chrome-stable package
FROM ciphrd/fxhash-dev-extract:v3
